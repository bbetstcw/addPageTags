...
## <a id="basics-of-authentication-in-azure-ad"></a>Azure AD 中的身份验证基本知识
...
## <a id="claims-in-azure-ad-security-tokens"></a>Azure AD 安全令牌中的声明
...
## <a id="basics-of-registering-an-application-in-azure-ad"></a>在 Azure AD 中注册应用程序的基本知识
...
## <a id="application-types-and-scenarios"></a>应用程序类型和方案
...
### <a id="web-browser-to-web-application"></a>Web 浏览器到 Web 应用程序
...
### <a id="single-page-application-spa"></a>单页面应用程序 (SPA)
...
### <a id="native-application-to-web-api"></a>本机应用程序到 Web API
...
### <a id="web-application-to-web-api"></a>Web 应用程序到 Web API
...
### <a id="daemon-or-server-application-to-web-api"></a>后台或服务器应用程序到 Web API

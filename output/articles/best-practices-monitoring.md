...
### <a id="analyzing-availability-data"></a>分析可用性数据
...
### <a id="SLA-monitoring"></a>SLA 监视的要求
...
## <a id="instrumenting-an-application"></a>检测应用程序
...
### <a id="information-for-correlating-data"></a>关联数据的信息
...
### <a id="instrumenting-an-application"></a>检测应用程序的最佳实践
...
### <a id="supporting-hot-warm-and-cold-analysis"></a>支持热、暖和冷分析

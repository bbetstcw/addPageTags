...
根据[此处](#ContentKeyAuthorizationPolicies2)所示创建“令牌限制策略”。
...
根据[此处](#ContentKeyAuthorizationPolicies2)所示将 ContentKeyAuthorizationPolicies 与 Options 相链接。

####将授权策略添加到内容密钥

根据[此处](#ContentKeyAuthorizationPolicies2)所示将 AuthorizationPolicy 添加到 ContentKey。

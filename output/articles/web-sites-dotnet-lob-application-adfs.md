...
## <a id="bkmk_deploy"></a>将示例应用程序部署到 Azure 网站中
...
## <a id="bkmk_rptrusts"></a>在 AD FS 管理中配置信赖方信任 ##
...
## <a id="bkmk_authorize"></a>为特定控制器或操作的用户授权

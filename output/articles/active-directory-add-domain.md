...
### <a id="add-and-verify-a-domain-using-the-azure-management-portal"></a>使用 Azure 管理门户添加和验证域
...
### <a id="edit-dns-records-for-your-cloud-services"></a>编辑云服务的 DNS 记录
...
### <a id="verify-a-domain-at-any-domain-name-registrar"></a>在任一域名注册机构验证域
...
## <a id="how-can-i-change-the-primary-domain-name-for-users?"></a>如何更改用户的主域名？
